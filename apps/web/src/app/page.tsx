...
const signals = [
  ['01', 'DATA DEMAND', 'AI expands the amount of useful data required to build, evaluate and operate intelligent systems.'],
  ['02', 'CONSENT', 'Permission, purpose and participant choice increasingly belong in the architecture—not a footnote.'],
  ['03', 'PROVENANCE', 'Enterprise intelligence needs a clearer chain between data origin, access conditions and use.'],
  ['04', 'PARTICIPATION', 'A durable data economy needs mechanisms for people and systems contributing value to participate.'],
];

const architecture = [
  ['01', 'Individual', 'Rights begin with the participant.'],
  ['02', 'Consent', 'Access is shaped by explicit permission.'],
  ['03', 'Data', 'Useful information remains the underlying asset.'],
  ['04', 'Privacy', 'Sensitive information is treated as a design constraint.'],
  ['05', 'Verification', 'Claims and actions can be evaluated against defined rules.'],
  ['06', 'Enterprise', 'Permissioned access connects infrastructure to demand.'],
  ['07', 'Participation', 'Economic coordination closes the loop.'],
];

const allocation = [
  ['40%', 'User rewards'], ['20%', 'Ecosystem'], ['15%', 'Team'], ['15%', 'Strategic partnerships'], ['10%', 'Treasury'],
];
  ...
  return <SiteShell>
    <main>
      <section className="hero shell" id="top">
        ...
        <Reveal><h1>ETHICAL DATA<br /><em>INFRASTRUCTURE</em><br />FOR THE AI ECONOMY.</h1></Reveal>
        <Reveal><p className="heroLead">AI is increasing the value of data. DataTrust is designing infrastructure around the rights, consent, provenance, access and participation that increasingly determine how that value can be used.</p></Reveal>
        <Reveal className="heroActions"><div><a className="button primary" href="/presale">Explore the presale <span>↗</span></a><a className="button secondary" href="/whitepaper">Read the whitepaper <span>→</span></a></div></Reveal>
        <div className="signalField" aria-hidden="true"><span/><span/><span/><span/><span/><span/></div>
      ...
      <section className="section shell" id="ai-economy">
        ...
        <div className="thesisGrid"><Reveal><div className="thesisNumber">01</div><h3>From extraction to permission</h3><p>Data access can be designed around defined rights and purposes rather than assumed availability.</p></Reveal><Reveal><div className="thesisNumber">02</div><h3>From opaque origin to provenance</h3><p>Data quality and legitimacy are easier to reason about when origin and access conditions are represented.</p></Reveal><Reveal><div className="thesisNumber">03</div><h3>From contribution to participation</h3><p>The people and systems that contribute useful data can have a clearer place in the economic model.</p></Reveal></div>
      </section>
      ...
      <section className="section shell" id="presale">
        <Reveal><div className="eyebrow">06 / PARTICIPATION</div><h2>Understand the terms before you participate.</h2><p>The presale interface is built around explicit order states, payment evidence, manual verification and a derived allocation ledger. Current configuration remains gated until the canonical price, routes and legal/operational clearance are supplied.</p></Reveal>
      ...
      <section className="section shell" id="roadmap">
        <Reveal><div className="eyebrow">07 / ROADMAP</div><h2>Build the foundation. Then extend the network.</h2><p>Phase I establishes the investor experience and the operational primitives required before broader protocol infrastructure is introduced.</p></Reveal>
      ...
      <section className="section shell closing" id="docs">
        <Reveal><div className="eyebrow">08 / DOCUMENTATION & RISK</div><h2>Serious systems deserve serious documentation.</h2><p>Read the whitepaper, tokenomics, presale terms and risk disclosures as the primary source for project claims. Vision, current implementation and planned infrastructure are deliberately separated.</p><div className="docActions"><a className="button secondary" href="/whitepaper">Read whitepaper <span>→</span></a><a className="button secondary" href="/risk">Review risk & disclosures <span>→</span></a></div></Reveal>
      </section>
    </main>
  </SiteShell>;
}
